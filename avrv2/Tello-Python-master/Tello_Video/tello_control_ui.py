...
class TelloUI:
    ...
    def __init__(self,tello,outputpath):
        ...
        # create buttons
        self.btn_snapshot = ttk.Button(self.root, text="Snapshot!",
                                       command=self.takeSnapshot)
        self.btn_snapshot.grid(side="bottom", fill="both",
                               expand="yes", padx=10, pady=5)

        self.btn_pause = ttk.Button(self.root, text="Pause", command=self.pauseVideo)
        self.btn_pause.grid(side="bottom", fill="both",
                            expand="yes", padx=10, pady=5)

        self.btn_landing = ttk.Button(
            self.root, text="Open Command Panel", command=self.openCmdWindow)
        self.btn_landing.grid(side="bottom", fill="both",
                              expand="yes", padx=10, pady=5)
    ...
    def openCmdWindow(self):
        ...
        self.btn_takeoff = ttk.Button(
            panel, text="Takeoff", command=self.telloTakeOff)
        self.btn_takeoff.grid(side="bottom", fill="both",
                              expand="yes", padx=10, pady=5)
        ...
        self.distance_bar = ttk.Scale(panel, from_=0.02, to=5, tickinterval=0.01, digits=3, label='Distance(m)',
                                  resolution=0.01)
        ...
        self.degree_bar = ttk.Scale(panel, from_=1, to=360, tickinterval=10, label='Degree')
